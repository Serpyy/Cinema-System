...
<html>
    ...
    <body>
        ...
        <div class="card">
            <%
            String currentName=ssLogUser.getCust_name();
            String currentEmail=ssLogUser.getEmail();
            String currentMobileNo=ssLogUser.getPhone_no();
            String currentIcNo=ssLogUser.getIc_no();
            String currentSecurityQuestion=ssLogUser.getSecurity_question();
            String currentAnswer=ssLogUser.getAnswer();
            %>
            
            <div class="container">
                <br>
                <h3 class="header" style="font-size: 25px;">Edit Profile <a href="viewProfile.jsp" class="fa fa-reply" aria-hidden="true"></a></h3>
                <br>
                <form name="edit_profile_form" action="editProfile" method="post">
                    <table class="profile_table" style="width:60%">
            
                    <tr>
                      <th width="30%" style="color:grey">Name</th>
                      <td width="2%" style="color:grey">:</td>
                      <td><input type="text" class="form-control" name="name" value="<%=currentName%>"></td>
                    </tr>
                    <tr>
                      <th width="30%" style="color:grey">Mobile Number	</th>
                      <td width="2%" style="color:grey">:</td>
                      <td><input type="text" class="form-control" name="mobileNumber" value="<%=currentMobileNo%>"></td>
                    </tr>
                    <tr>
                      <th width="30%" style="color:grey">Email</th>
                      <td width="2%" style="color:grey">:</td>
                      <td><input type="email" class="form-control" name="email" value="<%=currentEmail%>"></td>
                    </tr>
                    <tr>
                      <th width="30%" style="color:grey">IC No</th>
                      <td width="2%" style="color:grey">:</td>
                      <td><input type="text" class="form-control" name="icNo" value="<%=currentIcNo%>"></td>
                    </tr>
                    <tr>
                      <th width="30%" style="color:grey">Security Question</th>
                      <td width="2%" style="color:grey">:</td>
                      <td><select name="securityQuestion" style="background: transparent; color: white; border: none; border-bottom: solid 1px;">
                            <option value="<%=currentSecurityQuestion%>" selected><%=currentSecurityQuestion%></option>
                    ...
                    <tr>
                      ...
                      <td width="2%" style="color:grey">:</td>
                      <td><input type="text" class="form-control" name="answer" value="<%=currentAnswer%>"></td>
                    </tr>
                    
                  </table>
        
                <div class="btn-container">
                    <input class="submit_profile" type="submit" value="Save Changes" style="color:black;">
                    <a href="changePassword1.jsp" style="color:yellow;" class="text">Change Password</a>     
                </div>
        </form>
        </div>
            </div>
