...
<%
       ...
       Refund refund = (Refund)session.getAttribute("ssRefund");
      ...
      <div class="container">
          ...
          <div id="Summary">
              ...
              <div>
                     ...
                     Your Refund Request has been submited.
                </div>
                <table>
                  <tr>
                      <td>Refund Number</td>
                  ...
                  <input hidden type="text" name="txtID" class="display" value="<%= refund.getPayment().getCard().getCustomer().getCust_ID() %>" size="10" readonly /><br>
