...
<%
    ...
    Voucher addedvoucher = (Voucher)session.getAttribute("sssAddedVouncher");
  ...
  <body>
    ...
    <div class="movie-table-container" style="margin-right:200px;">
        ...
        <div class="container">
            <br><br>
            <div id="Summary">
                <h3 id="summaryh3" > Voucher </h3>
                <form method="get" action="Voucher">
                        <table>
                            <tr>
                                <td>Voucher Number </td>
                                <td><input type="text" class="display" value="<%=addedvoucher.getVoucher_no() %>" readonly="true" disabled></td>
                            </tr>
                            <tr>
                                <td>Customer ID </td>
                                <td><input type="text" class="display" name="txtID" value="<%=addedvoucher.getCustomer().getCust_ID() %>" readonly="true"></td>
                            </tr>
                            <tr>
                                <td>Customer Name  </td>
                                <td><input type="text" class="display" value="<%=addedvoucher.getCustomer().getCust_name()%>" disabled readonly="true"></td>
                            </tr>
                            <tr>
                                <td>Discount amount</td>
                                <td><input type="text" class="display" value="<%=addedvoucher.getDis_amount() %>"disabled readonly="true"></td>
                            </tr>
                            <tr>
                                <td>Point Left</td>
                                <td><input type="text" class="display" value="<%=cust.getPoint() %>"disabled readonly="true"></td>
                            </tr>
                        </table>
