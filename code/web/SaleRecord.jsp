...
<%@page import="controller.SaleRecord"%>
<%@page import="model.Payment"%>
<%@page import="model.*, java.util.*"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<jsp:include page="/SaleRecord"/>
...
<html>
    ...
    <body>
        ...
        <div class="container1">
            <h1 style="color: yellow;text-align: center" >SALES RECORD</h1>
                <div class="selection">  
                <select  id="searchfilter" style="width: 200px; height: 40px;background-color: darkgray; text-align: center;font-size: 20px">
                   ...
                   <option value="2">Purchase Date</option>
                </select>
            ...
            <table border="1" id="SaleTable">
                ...
                <th onclick="sortTable(3)">Purchase Time</th>
                ...
                <tr>
                    ...
                    <td><%= paymentlist[i].getPayment_time() %> </td>
