            ...
            <div class="navbar-container">
                ...
                <div class="menu-container">
                    ...
                    <ul class="menu-list">
                        ...
                        <div class="container4" style="margin-bottom: 30%">
    <form class="form1" method="get" action="SaleReport">
        <label class="label1" for="FromPaymentDate">Select a Date From</label>
        <input  class="input1" type="date" id="FromPaymentDate" name="fromDate" required>
         <label class="label1" for="ToPaymentDate">To</label>
         <input class="input1" type="date" id="ToPaymentDate" name="toDate" required>
